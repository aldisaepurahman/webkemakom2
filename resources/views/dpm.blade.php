    ...
    <div class="bemCovers">
        <div class="bemBlurs">
            <div class="col-md-12 col-sm-12 col-12 pt-5">
                ...
                <div class="row mt-5">
                    <h2 class="display-2 mx-auto headers-purple">KABINET NOVA HARMONIA</h2>
                    <h2 class="display-2 mx-auto whitened">2020</h2>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="col-md-12 col-sm-12 col-12">
            ...
            <div class="row mt-2">
                <div class="col-md-12 col-sm-12 col-12">
                    ...
                    <div class="col-md-12 col-sm-12 col-12 infoText">
                        <h1 class="display-6">NAMA BADAN</h1>
                        <div class="underlinePurple"></div>
            ...
            <div class="row mt-2">
                <div class="col-md-12 col-sm-12 col-12">
                    ...
                    <div class="col-md-12 col-sm-12 col-12 infoText">
                        <h1 class="display-6">NAMA BADAN 2</h1>
                        <div class="underlinePurple"></div>
                        <p class="pt-3">Menjadikan BEM Kemakom yang aktif dan berdaya juang tinggi dalam 
                            kinerja sehingga dapat menebar manfaat bagi Kemakom.Menjadikan BEM Kemakom yang aktif dan berdaya juang tinggi dalam 
                            kinerja sehingga dapat menebar manfaat bagi Kemakom.Menjadikan BEM Kemakom yang aktif dan berdaya juang tinggi dalam 
            ...
            <div class="row mt-2">
                <div class="col-md-12 col-sm-12 col-12">
                    ...
                    <div class="col-md-12 col-sm-12 col-12 infoText">
                        <h1 class="display-6">NAMA BADAN 3</h1>
                        <div class="underlinePurple"></div>
                        <p class="pt-3">Menjadikan BEM Kemakom yang aktif dan berdaya juang tinggi dalam 
                            kinerja sehingga dapat menebar manfaat bagi Kemakom.Menjadikan BEM Kemakom yang aktif dan berdaya juang tinggi dalam 
                            kinerja sehingga dapat menebar manfaat bagi Kemakom.Menjadikan BEM Kemakom yang aktif dan berdaya juang tinggi dalam 
